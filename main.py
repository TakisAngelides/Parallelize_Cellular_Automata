...
initial_state = np.zeros((width, height), dtype = np.int128)
...
configurations = np.empty((num_iterations + 1, width, height), dtype = np.int128)  # Array to store configurations on CPU
